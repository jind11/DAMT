...
DATA_PATH=/data/medg/misc/jindi/nlp/datasets/OPUS/de-en/WMT14
...
if [ "$SRC" == "de" -a "$TGT" == "en" ]; then
  ...
  PARA_SRC_VALID=$DATA_PATH/newstest2013.$SRC
  PARA_TGT_VALID=$DATA_PATH/newstest2013.$TGT
  PARA_SRC_TEST=$DATA_PATH/newstest2014.$SRC
  PARA_TGT_TEST=$DATA_PATH/newstest2014.$TGT
fi
