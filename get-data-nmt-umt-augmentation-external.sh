...
PROC_PATH=$DATA_PATH/umt_newsletter_augmentation_${SRC_DATA_NUM}
SRC_DATA_PATH=/data/medg/misc/jindi/nlp/datasets/UMT/data/processed/$SRC-$TGT
...
{ shuf -n $SRC_DATA_NUM $SRC_DATA_PATH/train.$SRC & cat ${DATA_PATH}/processed/$SRC-$TGT/train.$SRC; } > $SRC_TRAIN_BPE
{ shuf -n $SRC_DATA_NUM $SRC_DATA_PATH/train.$TGT & cat ${DATA_PATH}/processed/$SRC-$TGT/train.$TGT; } > $TGT_TRAIN_BPE
