...
def main():
    ...
    args.cuda_visible_device_ids = list(map(int, args.cuda_visible_device_ids[0].split(',')))\
    ...
    if len(split_files) != args.chunks:
        ...
        print("splitting files from {}...".format(args.data))
    ...
    if count_line(generated_src) != count_line(generated_tgt) or count_line(generated_src) <= 0:
        ...
        with TempFile() as fout:
            ...
            # check_call(f"cat {translation_dir}/mono*.log", shell=True, stdout=fout)
