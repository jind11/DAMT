...
DATA_PATH=/data/medg/misc/jindi/nlp/datasets/OPUS/$SRC-$TGT/TED_mono
EXT_DATA_PATH=/data/medg/misc/jindi/nlp/datasets/OPUS/$SRC-$TGT/TED
...
SRC_RAW=$DATA_PATH/train.$SRC.mono
TGT_RAW=$DATA_PATH/train.$TGT.mono
SRC_TOK=$SRC_RAW.tok
TGT_TOK=$TGT_RAW.tok
...
#
ln -sf $EXT_DATA_PATH/processed/$SRC-$TGT/valid.$SRC.pth $SRC_VALID_BPE.pth
ln -sf $EXT_DATA_PATH/processed/$SRC-$TGT/valid.$TGT.pth $TGT_VALID_BPE.pth
ln -sf $EXT_DATA_PATH/processed/$SRC-$TGT/test.$SRC.pth  $SRC_TEST_BPE.pth
ln -sf $EXT_DATA_PATH/processed/$SRC-$TGT/test.$TGT.pth  $TGT_TEST_BPE.pth

ln -sf $EXT_DATA_PATH/processed/$SRC-$TGT/valid.$SRC-$TGT.$SRC.pth $PARA_SRC_VALID_BPE.pth
ln -sf $EXT_DATA_PATH/processed/$SRC-$TGT/valid.$SRC-$TGT.$TGT.pth $PARA_TGT_VALID_BPE.pth
ln -sf $EXT_DATA_PATH/processed/$SRC-$TGT/test.$SRC-$TGT.$SRC.pth  $PARA_SRC_TEST_BPE.pth
ln -sf $EXT_DATA_PATH/processed/$SRC-$TGT/test.$SRC-$TGT.$TGT.pth  $PARA_TGT_TEST_BPE.pth
