...
epoch_size=$(cat /data/medg/misc/jindi/nlp/datasets/OPUS/$SRC-$TGT/$DATA_NAME/umt_newsletter_augmentation_${SRC_DATA_NUM}/train.$SRC | wc -l)
...
python -W ignore train.py \
    --exp_name umt_src_newsletter_${SRC_DATA_NUM}_augmentation_tgt_${DATA_NAME}_${SRC}_${TGT} \
    --dump_path ./tmp/ \
    ...
    --data_path /data/medg/misc/jindi/nlp/datasets/OPUS/$SRC-$TGT/$DATA_NAME/umt_newsletter_augmentation_${SRC_DATA_NUM} \
    --lgs $SRC-$TGT \
    --ae_steps $SRC,$TGT \
