...
for SAMPLE_SIZE in 10000; do

MAIN_PATH=$PWD
DATA_PATH=/data/medg/misc/jindi/nlp/datasets/OPUS/$ORDERED_SRC-$ORDERED_TGT/$DATA_NAME
PROC_PATH=$DATA_PATH/processed/$ORDERED_SRC-$ORDERED_TGT
OUT_DATA_DIR=$DATA_PATH/processed_subsample_${SAMPLE_SIZE}
FULL_VOCAB=$PROC_PATH/vocab.$ORDERED_SRC-$ORDERED_TGT

mkdir -p $OUT_DATA_DIR
python sub_sample.py $DATA_NAME $SRC $TGT $SAMPLE_SIZE $OUT_DATA_DIR
