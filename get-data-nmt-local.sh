...
PARA_SRC_VALID=$DATA_PATH/dev.$SRC
PARA_TGT_VALID=$DATA_PATH/dev.$TGT
PARA_SRC_TEST=$DATA_PATH/test.$SRC
PARA_TGT_TEST=$DATA_PATH/test.$TGT
...
#
cd $PROC_PATH
ln -sf valid.$SRC-$TGT.$SRC.pth valid.$SRC.pth
ln -sf valid.$SRC-$TGT.$TGT.pth valid.$TGT.pth
ln -sf test.$SRC-$TGT.$SRC.pth test.$SRC.pth
ln -sf test.$SRC-$TGT.$TGT.pth test.$TGT.pth
